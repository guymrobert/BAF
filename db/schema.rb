...
ActiveRecord::Schema.define(version: 2021_12_13_125907) do
  ...
  create_table "erc20_tokens", charset: "utf8", force: :cascade do |t|
    t.string "address"
    t.string "chain_id"
    t.string "name"
    t.string "symbol"
  ...
  create_table "featured_collections", charset: "utf8", force: :cascade do |t|
  ...
  create_table "featured_users", charset: "utf8", force: :cascade do |t|
  ...
  create_table "nft_contracts", charset: "utf8", force: :cascade do |t|
    t.string "name"
    t.string "symbol"
    t.string "address"
  ...
  create_table "report_users", charset: "utf8", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.text "message"
